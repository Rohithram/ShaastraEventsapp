...
import com.google.android.gms.maps.model.MarkerOptions;
        ...
        public class Mapactivity extends FragmentActivity implements OnMapReadyCallback {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                code = map.getStringExtra("code");
                lat = map.getStringExtra("lat");
                lng = map.getStringExtra("lng");
                loc = map.getStringExtra("loc");
                lat1= Double.parseDouble(lat);
                lng1=Double.parseDouble(lng);// Make use of autoboxing.  It's also easier to read.
            }
            /**
